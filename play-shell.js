...
(function(){
  ...
  const q0=new URLSearchParams(location.search), t=q0.get('teacher'), g=q0.get('group'); a.href='index.html'+(t?'?teacher='+encodeURIComponent(t)+(g?'&group='+encodeURIComponent(g):''):''); /* 2026-09-17: 모둠(group)도 유지 */ a.textContent='🎹 연주실';
